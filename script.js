...
// // manageMemory(1,2,3,4,5,6,7,8,9)
...
// // let c3 = array1[2][0]
// // let c4 = array1[2][1][0]
// // let c5 = array1[2][1][1][0]

// // console.log(c1,c2,c3,c4,c5);

// // // destracture 

// // let [d1,d2,[d3,[d4,[d5]]]] = array1
...
// // let {red,yellow,big} = object1

// // console.log(red,yellow,big);
...
// // if you use add concept - u can add multiple value.

// // if you use remove concept - u can remove single value only.



// // array advance 

// let aa = [1,2,3,4,"hello",true,undefined,null,[1,2],{k:1}]
...
// // push() - we can add array of last value

// abc.push(4,5,6,7,8)

// // pop()  - we can remove array of last value

// abc.pop()

// // shift() - we can remove array of first value

// abc.shift()

// // unshift() - we can add array of first value
...
// // splice() - startingIndex , deleteCount , add value

// let ac = [1,2,3,40,50,60,7,8]
...
// let total = ar1.concat(ar2,10,11)
...
// let ex1 = [1,2,3,55,66,77,8,9,10]

// let particularVal = ex1.slice(6,9) // sI , eI + 1

// console.log(particularVal);
...
// let nestedVal = nest.flat(Infinity)
...
// let ex2 = [1,2,3,4] // 1,2,3, "four"

// ex2.fill("four",3,4) // value , sI , eI + 1
...
// let ex3 = [1,2,44,55,32,12,0,8]

// console.log(ex3.includes(0));


// // indexOf, 

// let ex4 = [1,2,3,4,5,4,3,2,1]

// console.log(ex4.indexOf(3));


// // lastIndexOf,

// console.log(ex4.lastIndexOf(3,5));


// // sort,

// let ex5 = [1,5,4,3,8,9,2,10,2000,555,678] // 2.000 < 3

// console.log(ex5.sort());
...
// let example = [100,2,4,75,67]

// console.log(example.sort());


// // higher order sort method (function )


// let finalVal = example.sort((a,b)=>{
...
let memoryVal = nrml(5)

let renrml = (memory1)=>{

    console.log(memoryVal + memory1);
...
let games = ["PUBG" , "COD" , "FF" , "NFS" , "SD"]


// forEach()

let newForEach = games.forEach((currentElement,indexNo,TotalArray)=>{
...
let allEmployee = [
    {eName : "karthikeyen" , salary : 200000},
    {eName : "sandiya" , salary : 300000},
    {eName : "narendra" , salary : 400000},
    {eName : "siva surya" , salary : 500000},
    {eName : "sivani" , salary : 600000}
]


let currentSalary = allEmployee.filter((c,i,t)=>{
...
let currentPersonSalary = allEmployee.find((c,i,t)=>{

    return c.salary >= 300000;

})

console.log(currentPersonSalary.eName);
...
let totalVal = allEmployee.reduce((acc,c,i,t)=>{
    return acc + c.salary
...
let newSome = someVal.some((c,i,t)=>{
...
let everyVal = [2,2,2,2]

let newEvery = everyVal.every((c,i,t)=>{
    return c % 2 == 0 
})
...
let array = [30,4,5,6,22,0,43212,89]

let newSort = array.sort((l,h)=>{
...
let salary = [12756,117676,457865,32990,7675]


let finalVal = salary.reduce((acc,c,i,t)=>{
...
let firstLatter = str3.slice(0,4).toUpperCase()

console.log(firstLatter);

let Remain     = str3.slice(1,str3.length)

console.log(firstLatter+Remain);
...
console.log(str.indexOf("a",2)); // value , fromIndex
...
let marvel = "spider-man"

console.log(marvel.split("e"));
